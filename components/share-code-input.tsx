    ...
    <Card className="w-full max-w-md mx-auto bg-transparent border-none shadow-none">
      <CardContent>
        <form autoFocus={false} onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-[#31AFAD] pushable flex items-center justify-center"
          >
            {isLoading ? (
              <div className="flex bg-[#6FCCCA] items-center gap-2 front text-background w-full">
                <p className="flex items-center justify-center font-bold text-lg py-1 gap-2">
