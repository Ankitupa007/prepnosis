...
export async function GET(
    ...
    try {
        ...
        // Cached Supabase query with per-user tag for invalidation
        const getCachedTests = unstable_cache(
          ...
          `)
            ...
            ['custom-tests', userId], // Cache key
            { tags: [`custom-tests-${userId}`], revalidate: 300 } // Tag for invalidation, revalidate every 5 minutes
        );

        const data = await getCachedTests(userId);
